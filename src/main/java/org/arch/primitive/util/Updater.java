...
public class Updater {
  ...
  private String currentPublicVersionURL = "https://github.com/loouislow81/arch-primitive-II/release/latest.txt";
  private String installationDir = "/opt/archprimitive-II/";
  private String sabproxyUserAgent = "ARCH-Primitive-UA/" + Utils.class.getPackage().getImplementationVersion();
  private String sabproxyUpdaterUserAgent = "ARCH-Primitive-UA/" + Utils.class.getPackage().getImplementationVersion();
  private String tempDistFile = System.getProperty("java.io.tmpdir") + "/" + "arch-primitive-II.jar";
  ...
  public String getLatestVersion() {
    return getLatestDistJar().replace("arch-primitive-II-", "").replace(".jar", "").trim();
  }
  ...
  public void upgrade() {
    ...
    try {
      ...
      log.info("Upgrading ARCH-Primitive II...");
